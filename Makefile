...
ALL_MODULES = odin-api-schema-manager odin-api-identity odin-api-crm odin-api-product-catalog odin-api-orders odin-api-billing odin-api-notifications odin-api-support odin-api-field-service odin-api-service odin-api-projects odin-api-connect odin-api-search
WORK_MODULES = odin-api-schema-manager odin-api-search
