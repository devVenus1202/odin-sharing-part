...
// This function goes over each of the filtered edges and returns the
  ...
  map?.once('postrender', function () {
    ...
    Array.prototype.forEach.call(
      document.querySelectorAll(
        '.ol-layer canvas, .overviewLayer_polygon canvas, .googleLayer canvas, .loopChainOverview canvas, .cableLayer canvas, .cableOverviewLayer canvas'),
      function (canvas) {
        if (canvas.width > 0) {
