        ...
        configurations.push(
          {
            ...
            fiberInId: getProperty(connection, 'FiberInId'),
            cableOutId: getProperty(connection, 'CableOutId'),
            tubeOutId: getProperty(connection, 'TubeOutId'),
            fiberOutId: getProperty(connection, 'FiberOutId'),
            modified: false,
          });
      }
    }
  ...
  fetchFiberConnections() {
    ...
    if(schema && record) {
      ...
      getAssociations({
        ...
        this.initializeFiberConnections();
    ...
    for(const row of modified) {
      ...
      const create = {
        ...
        properties: {
          ...
          FiberInId: row.fiberInId,
          CableOutId: row.cableOutId,
          TubeOutId: row.tubeOutId,
          FiberOutId: row.fiberOutId,
        },
        associations: [
          {
            recordId: record?.id,
      ...
      <Row wrap={false}>
          ...
          >
            ...
            >
              ...
              {this.getRelatedListData(
                ...
                <Option value={elem.id}>{getProperty(elem, 'FiberNumber')}</Option>
              ))}
            </Select>
          </Form.Item>
        </Col>
        ...
        <Col span={2}>
          <Form.Item
            ...
            label={'Fibre Out'}
            labelCol={{ span: 24 }}
            initialValue={config.fiberOutId}
            rules={[ { required: true } ]}
          >
