...
import { Card, Col, Layout, List, PageHeader, Row, Select, Statistic } from 'antd';
      ...
      <Layout style={{ padding: 14, overflow: 'auto' }}>
        ...
        <Card size="small" title="Active Customers" style={{ marginBottom: 16 }}>
          <Row gutter={16}>
            ...
            <Col flex={1}>
              <Card loading={reportReducer.isOrdersRequesting}>
                <Statistic title="Net order value" value={`£ ${ordersOverview?.sumNetProjectedRevenue}`}/>
              </Card>
            </Col>
            <Col flex={1}>
              <Card loading={reportReducer.isOrdersRequesting}>
                <Statistic title="ARPU" value={`£ ${ordersOverview?.netProjectedArpu}`}/>
              </Card>
            </Col>
          </Row>
        </Card>
