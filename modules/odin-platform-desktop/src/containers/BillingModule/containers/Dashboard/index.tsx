      ...
      <Layout style={{ padding: 14, overflow: 'auto'  }}>
        ...
        <Card size="small" title="Invoices generated in the last Bill Run" style={{ marginBottom: 16 }}>
          <Row gutter={[16, 16]}>
            ...
            <Col span={8} xs={24} md={8}>
              <BillingTemplateDataList
                title="Orders where the invoices were not created"
                link="/OrderModule/Order/:id"
                countAPI="BillingModule/v1.0/dashboards/invoices/not_created_last_bill_run"
                API="BillingModule/v1.0/dashboards/invoices/not_created_breakdown_last_bill_run"
              />
            </Col>
          </Row>
        </Card>
