...
import { Button, Checkbox, Col, Divider, Form, Input, Layout, Popconfirm, Row, Select } from 'antd';
        ...
        <Col span={18} offset={4}>
          ...
          <Row gutter={12}>
            ...
            <Col span={10}>
              ...
              <Form.Item
                className="form-item"
                initialValue={data?.titleCase}
                label="Title Case"
              >
                <Select defaultValue={data?.titleCase} onChange={(value) => { this.setState({ titleCase: value }) }} allowClear>
            ...
            <Col span={6}>
              ...
              >
                <Checkbox
                  ...
                  onChange={(e) => this.setState({ isHidden: e.target.checked })}>Is Hidden In Form</Checkbox>
              </Form.Item>
              <Form.Item
                className="form-item"
              ...
              >
                <Checkbox
                  ...
                  onChange={(e) => this.setState({ isVisibleInGlobalNav: e.target.checked })}>Is Visible In Navbar</Checkbox>
              </Form.Item>
              {this.state.isVisibleInGlobalNav && <Form.Item
                label="Menu Label"
                className="form-item"
                initialValue={data?.isVisibleInGlobalNav}
              >
                <Input placeholder="Menu Label" defaultValue={data?.menuLabel}
