  ...
  renderSchemaColumns() {
    ...
    const columns = [
      ...
      },
      {
        ...
        key: 'validators',
        width:'14%',
        render: (text: any, record: any) => text.map((elem:any) => <Tag color={this.getValidatorTagColor(elem.type)} key={elem.type}>{elem.type}</Tag>),
      }
    ];
    ...
    console.log('%cdataSource:', 'color:limegreen', dataSource)
