...
import NetworkDeviceLayout from "./SearchResultLayouts/NetworkDeviceLayout";
...
class SearchResult extends React.Component<Props, State> {
  ...
  renderSearchResultBody = (entityName: string, result: any) => {
    switch (entityName) {
      ...
      case 'Contact':
        return <ContactLayout result={result} onClose={this.props.onClose} globalCollapsed={this.props.globalCollapsed}/>
      case 'NetworkDevice':
        return <NetworkDeviceLayout result={result} onClose={this.props.onClose} globalCollapsed={this.props.globalCollapsed}/>
      default:
        return result.title
    }
  }
  ...
  renderResultIcon = (entityName: string) => {
    switch (entityName) {
      ...
      case 'Contact':
        return <UserOutlined className="resultHeaderIcon"/>
      case 'Address':
      ...
      case 'NetworkDevice':
        return <WifiOutlined className="resultHeaderIcon"/>
      default:
    }
  }
        ...
        title={
          <Row>
            <Col span={12}>
              ...
              <span
                style={{fontSize: '1em', marginTop: 0, marginLeft: '4px'}}>{searchResult.entity.split(':')[1]}</span>
            </Col>
