        ...
        <Col xs={24} sm={24} md={24} lg={12}>
          <div className="record-detail-left-panel">
            <CardWithTabs
              ...
              contentList={{
                File: (getProperty(record, 'Mimetype') ? getProperty(record, 'Mimetype').includes('image') : false)
                  ? <img style={{
                    width: 1000,
                  ...
                  : <Link target="_blank" to={{ pathname: getProperty(record, 'Url') }}>view {record?.title}</Link>,
                Related:
                  <div>
