...
export const getRecordRelatedRecordsFromShortList = (
  ...
  return associationObj ? associationObj[entity].dbRecords : undefined;
};
...
export const checkRecordIsLocked = (record: DbRecordEntityTransform | undefined): boolean => {
  if (record?.entity === `${SchemaModuleTypeEnums.BILLING_MODULE}:${SchemaModuleEntityTypeEnums.INVOICE}`) {
