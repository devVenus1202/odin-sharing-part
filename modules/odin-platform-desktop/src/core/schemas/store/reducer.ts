  ...
  switch (action.type) {
    ...
    case GET_SCHEMA_BY_MODULE_AND_ENTITY_REQUEST: {
      return {
        ...state,
        isRequesting: true,
        isRequestingByEntity: Object.assign({}, state.isRequestingByEntity, { [action?.params?.entityName]: true }),
        isSuccessful: false,
        isSuccessfulByEntity: Object.assign({}, state.isSuccessfulByEntity, { [action?.params?.entityName]: false }),
        searchQuery: action.searchQuery,
      }
    }
    case GET_SCHEMA_BY_MODULE_AND_ENTITY_SUCCESS: {
      return {
        ...state,
        isRequesting: false,
        isRequestingByEntity: Object.assign({}, state.isRequestingByEntity, { [action?.results?.entityName]: false }),
        isSuccessful: true,
        isSuccessfulByEntity: Object.assign({}, state.isSuccessfulByEntity, { [action?.results?.entityName]: true }),
    ...
    case GET_SCHEMA_BY_MODULE_AND_ENTITY_ERROR: {
      return {
        ...state,
        isRequesting: false,
        isRequestingByEntity: Object.assign({}, state.isRequestingByEntity, { [action?.params?.entityName]: false }),
        isSuccessful: false,
        isSuccessfulByEntity: Object.assign({}, state.isSuccessfulByEntity, { [action?.params?.entityName]: false }),
      }
    }
