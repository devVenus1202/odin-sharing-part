...
import { canUserCloneRecord, canUserDeleteRecord, canUserUpdateRecord, hasAnyRoles } from '../../../../shared/permissions/rbacRules';
import history from '../../../../shared/utilities/browserHisory';
import { changeToCapitalCase } from '../../../../shared/utilities/dataTransformationHelpers';
import { checkRecordIsLocked, getAllSchemaAssociationEntities, getBrowserPath } from '../../../../shared/utilities/recordHelpers';
          ...
          <PageHeader
            ...
            extra={[
              <>{
                schema?.entityName === 'ServiceAppointment' ?
                  ...
                  <Popconfirm
                    ...
                    disabled={
                      disableDelete || !canUserDeleteRecord(userReducer, schema, record)
              ...
              <Button key="1" type="primary" ghost
                      disabled={
                        disableEdit || !canUserUpdateRecord(userReducer, schema, record)
