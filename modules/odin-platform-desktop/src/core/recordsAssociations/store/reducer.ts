...
function reducer(state = initialState, action: any) {
  switch (action.type) {
    ...
    // Get record association with nested entities
    case GET_DB_RECORD_ASSOCIATION_WITH_NESTED_ENTITIES_REQUEST: {
      return {
        ...state,
        isRequesting: true,
        format: action.format,
    ...
    case GET_DB_RECORD_ASSOCIATION_WITH_NESTED_ENTITIES_SUCCESS: {
      return {
        ...state,
        isRequesting: false,
        shortList: Object.assign(
    ...
    case GET_DB_RECORD_ASSOCIATION_WITH_NESTED_ENTITIES_ERROR: {
      return {
        ...state,
        isRequesting: false,
      }
