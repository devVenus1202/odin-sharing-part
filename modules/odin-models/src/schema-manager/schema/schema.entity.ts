...
export class SchemaEntity extends Base {
  ...
  @ApiProperty()
  @ManyToMany(type => OrganizationUserRbacPermissionEntity, permission => permission.schema)
  ...
  /**
   * UI dynamic visibility property
   * if set to hidden, it will not show up on the nav
   */
  @ApiProperty()
  @Column({ type: 'boolean', default: false, nullable: false })
  ...
  /**
   * Menu label property
   * this label is for the global menu when isVisibleInGlobalNav is true
   */
  @ApiProperty()
  @Column({ type: 'boolean', default: false, nullable: false })
  ...
  public titleCase: ChangeCaseEnums;
}
