...
export class DbRecordAssociationCreateUpdateDto {
  ...
  /**
   * ODN-1474
   * Additional key value optional params for relation
   */
  @ApiProperty({ description: 'object with key value pairs of additional relation params' })
  public additionalParams?: { [key: string]: string | undefined };
}
